...
import hu.csaszi.gameengine.render.core.gl.loading.DeferredResource;
import hu.csaszi.gameengine.render.core.gl.loading.LoadingList;
...
public class DeferredSound extends AudioImpl implements DeferredResource {
	...
	private static final Logger logger = LoggerFactory.getLogger(DeferredSound.class);
	...
	public void load() throws IOException {
		...
		if (in != null) {
			...
			case AIF:
				...
				break;
			default:
				logger.error("Unrecognised sound type: "+type);
				break;
			}
		} else {
			switch (type) {
