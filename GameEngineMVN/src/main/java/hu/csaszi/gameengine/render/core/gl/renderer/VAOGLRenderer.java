...
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#initDisplay(int, int)
	 */
	...
	private void flushBuffer() {	
		...
		GL11.glVertexPointer(3, GL11.GL_FLOAT, 12, vertices);
		GL11.glColorPointer(4, GL11.GL_FLOAT, 12, colors);
		GL11.glTexCoordPointer(2, GL11.GL_FLOAT, 12, textures);
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#flush()
	 */
	public void flush() {
		super.flush();
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glColor4f(float, float, float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex2f(float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex3f(float, float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBindTexture(int, int)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBlendFunc(int, int)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glClipPlane(int, java.nio.DoubleBuffer)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glColorMask(boolean, boolean, boolean, boolean)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glRotatef(float, float, float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScalef(float, float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScissor(int, int, int, int)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexEnvi(int, int, int)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTranslatef(float, float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glEndList()
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glNewList(int, int)
	 */
