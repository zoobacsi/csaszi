...
public class TextureImpl implements Texture {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TextureImpl.class);

    /**
     * The renderer to use for all GL operations
     */
    protected static GL GL = Renderer.get();
    ...
    public byte[] getTextureData() {
        ...
        bind();
        GL.glGetTexImage(GL.GL_TEXTURE_2D, 0, hasAlpha() ? GL.GL_RGBA : GL.GL_RGB, GL.GL_UNSIGNED_BYTE,
                buffer);
    ...
    public void setTextureFilter(int textureFilter) {
        bind();
        GL.glTexParameteri(target, GL.GL_TEXTURE_MIN_FILTER, textureFilter);
        GL.glTexParameteri(target, GL.GL_TEXTURE_MAG_FILTER, textureFilter);
    }
