...
public class SpriteSheet extends Image {
	 ...
	 * @throws GameException Indicates a failure to read image data
	 * @throws IOException Indicates the URL could not be opened
	 */
	public SpriteSheet(URL ref, int tw, int th) throws GameException, IOException {
	 ...
	 */
	public SpriteSheet(String ref, int tw, int th, int spacing) throws GameException {
	 ...
	 * @throws GameException Indicates a failure to load the image
	 */
	public SpriteSheet(String ref, int tw, int th) throws GameException {
		this(ref,tw,th,null);
	}
	 ...
	 * @throws GameException Indicates a failure to load the image
	 */
	public SpriteSheet(String ref, int tw, int th, Color col) throws GameException {
	 ...
	 * @throws GameException Indicates a failure to load the image
	 */
	public SpriteSheet(String ref, int tw, int th, Color col, int spacing) throws GameException {
	 ...
	 * @throws GameException Indicates a failure to load the image
	 */
	public SpriteSheet(String name, InputStream ref, int tw, int th) throws GameException {
