 ...
 * @author kevin
 */
public abstract class GameEngineCallable {
	 ...
	 *
	 * @throws GameException Indicates a failure while performing the GL operations or
	 * maintaing SlickState
	 */
	public final void call() throws GameException {
		enterSafeBlock();
	 ...
	 * 
	 * @throws GameException Indicates a failure of some sort. This is user exception
	 */
	protected abstract void performGLOperations() throws GameException;
}
