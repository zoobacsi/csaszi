...
public class QuadBasedLineStripRenderer implements LineStripRenderer {
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.LineStripRenderer#start()
	 */
	public void start() {
		if (width == 1) {
			def.start();
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.LineStripRenderer#end()
	 */
	public void end() {
		if (width == 1) {
			def.end();
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.LineStripRenderer#vertex(float, float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.LineStripRenderer#setWidth(float)
	 */
	...
	/**
	 *  org.newdawn.slick.opengl.renderer.LineStripRenderer#color(float, float, float, float)
	 */
