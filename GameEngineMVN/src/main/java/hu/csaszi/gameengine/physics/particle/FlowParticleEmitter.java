...
public class FlowParticleEmitter implements IParticleEmitter {
    ...
    private final List<RenderObject> particles;
    ...
    @Override
    public List<RenderObject> getParticles() {
        return particles;
    }
    ...
    public void update(long ellapsedTime) {
        ...
        Iterator<? extends RenderObject> it = particles.iterator();
        while (it.hasNext()) {
    ...
    @Override
    public void cleanup() {
        for (RenderObject particle : getParticles()) {
            particle.destroy();
        }
    }
}